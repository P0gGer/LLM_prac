...
DEFAULE_EMBED_MODEL = 'text-embedding-3-small'

@st.cache_resource(show_spinner=False)
def configure_llama_index() -> None:
    """라마인덱스 전역 설정을 한번만 구성하는 함수"""
...
def main() -> None:
    ...
    with st.sidebar:
        ...
        st.write(f'Embedding: {DEFAULE_EMBED_MODEL}')
    ...
    with col2:
        top_k = st.sidebar('검색할 근거 수', min_value=1, max_value=5)
    ...
    if ask:
        ...
        query_engine = index.as_query_engine(similarity_top=top_k)
